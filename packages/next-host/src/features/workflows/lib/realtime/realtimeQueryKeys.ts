...
export const workflowDebuggerOverlayQueryKey = (workflowId: string) => ["workflow-debugger-overlay", workflowId] as const;
...
export const workflowCredentialHealthQueryKey = (workflowId: string) => ["workflow-credential-health", workflowId] as const;
