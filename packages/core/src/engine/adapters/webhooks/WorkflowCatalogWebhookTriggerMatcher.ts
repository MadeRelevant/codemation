...
/**
 * Resolves webhook HTTP routes from the live workflow catalog (no trigger setup / registration).
 * Maintains an in-memory index keyed by user-defined endpoint path for O(1) lookups after reload.
 */
export class WorkflowCatalogWebhookTriggerMatcher implements WebhookTriggerMatcher {
