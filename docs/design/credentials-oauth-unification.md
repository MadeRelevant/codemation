...
>
> **How to use it**: this is the source of truth for the work. Each phase below maps to a story in [`docs/sprints/sprint-17-credentials-oauth-unification.md`](../sprints/sprint-17-credentials-oauth-unification.md). When something here changes mid-flight, update both docs in the same PR.
>
