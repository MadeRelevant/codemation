...
import type { PersistedWorkflowSnapshot } from "../realtime/realtime";
import type { WorkflowDto, WorkflowNodeDto } from "../realtime/workflowTypes";

export class CodemationPersistedWorkflowDtoMapper {
  toDetail(snapshot: PersistedWorkflowSnapshot): WorkflowDto {
