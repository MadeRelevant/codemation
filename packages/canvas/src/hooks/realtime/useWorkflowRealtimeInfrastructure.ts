...
import { applyWorkflowEvent } from "../../realtime/realtimeRunMutations";
import { applyTelemetrySpanEvent } from "../../realtime/realtimeTelemetryMutations";
import {
...
export function useWorkflowRealtimeInfrastructure(
  ...
  const websocketUrl = useMemo(() => {
    if (args.wsBaseUrl) return args.wsBaseUrl;
