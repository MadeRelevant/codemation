  ...
  messages: [
    {
      role: "system",
      content:
        'You triage incoming mail. Return strict JSON only with shape {"outcome":"rfq"|"other","summary":"..."}',
    },
    {
      role: "user",
  ...
  messages: [
    {
      role: "system",
      content:
        'Return strict JSON only. Shape: {"category":"sales"|"support"|"spam","reasoning":"..."}',
    },
    {
      role: "user",
      content: ({ item }) =>
