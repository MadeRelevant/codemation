...
That starts the framework-owned UI and the runtime behind it. To change discovery, authentication, database persistence, engine settings, credentials, or other wiring, edit `<project-name>/codemation.config.ts`.
